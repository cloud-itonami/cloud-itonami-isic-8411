...
```bash
kbb -M:dev:run     # walk two clean decide+notify lifecycles (non-adverse decision, adverse decision with appeal rights disclosed), plus four HARD-hold cases, through the actor
