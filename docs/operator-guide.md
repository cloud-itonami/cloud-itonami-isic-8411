...
- human sign-off for :high/:safety-critical robot actions (e.g. handling citizen data, official decisions and public-works dispatch)
...
## Operating states
intake : register : decide : notify : appeal : audit
